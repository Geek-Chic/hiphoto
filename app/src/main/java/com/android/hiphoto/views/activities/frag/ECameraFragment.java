 ...
 */
public class ECameraFragment extends CameraFragment implements
        SeekBar.OnSeekBarChangeListener {
    /**
     * 是否是前置摄像头
     */
    public static final String KEY_USE_FFC=
    ...
    public static ECameraFragment newInstance(boolean useFFC) {
        ECameraFragment f=new ECameraFragment();
...
//                startActivity(new Intent(getActivity(), DisplayActivity.class));
        ...
        public Camera.Parameters adjustPreviewParameters(Camera.Parameters parameters) {
            ...
            if (doesZoomReallyWork() && parameters.getMaxZoom() > 0) {
                ...
                zoom.setOnSeekBarChangeListener(ECameraFragment.this);
            }
            else {
                zoom.setEnabled(false);
            }
