 ...
 */
package com.android.hiphoto.views.utils;
...
import com.android.hiphoto.views.config.SystemConfig;
...
public class PreferencesUtil
{
    ...
    private static SharedPreferences getSharedPreferences()
    {
        ...
        {
            mSharedPreferences = mContext.getSharedPreferences(SystemConfig.SHARED_PREFERENCE_NAME,
