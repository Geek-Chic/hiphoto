...
import static com.android.geekchic.common.log.LogUtils.LOGD;
...
public class PrefUtils  {
    ...
    @TargetApi(Build.VERSION_CODES.GINGERBREAD) public static void markUserRefusedSignIn(final Context context, final boolean refused) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
